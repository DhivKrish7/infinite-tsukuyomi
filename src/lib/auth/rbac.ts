...
export const routeRolePolicy: Record<string, string[]> = {
  ...
  "/marketing": [ROLE.SUPER_ADMIN, ROLE.ADMIN, ROLE.MANAGER],
...
export const routePermissionPolicy = [
  ...
  { prefix: "/api/management/forms", permissions: [PERMISSION.FORMS_MANAGE] },
  { prefix: "/api/management", permissions: [PERMISSION.MANAGEMENT_READ] },
  { prefix: "/api/marketing", permissions: [PERMISSION.MARKETING_READ] },
  { prefix: "/api/reports", permissions: [PERMISSION.ANALYTICS_READ] },
  { prefix: "/api/exposure", permissions: [PERMISSION.PLATFORMS_MANAGE] },
  ...
  { prefix: "/reports", permissions: [PERMISSION.ANALYTICS_READ] },
  { prefix: "/exposure", permissions: [PERMISSION.PLATFORMS_MANAGE] },
  { prefix: "/marketing", permissions: [PERMISSION.MARKETING_READ] },
